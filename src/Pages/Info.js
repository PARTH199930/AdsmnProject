  ...
  const handleFormSubmit = async (formData) => {
    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      headers: {
        ...
        Authorization:
          "Bearer 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",
      },
      body: JSON.stringify({
        model: "gpt-3.5-turbo",
        script: `Wish a happy birthday to "Parth". 
        ...
        Using the above information, please write 16 lines of ${selectGenre} lyrics that I can dedicate to ${setselectGender} for ${setselectGender ? setselectGender === "his" ? "him" : "her" : "" }  birthday. 
  ...
  return (  
    <>
      ...
      <Row>
        ...
        <Col span={6}>
          <img
            style={{ maxWidth: "60%", height: "auto", paddingTop: "25px" }}
            src={Balloon2}
          />
        </Col>
      </Row>
